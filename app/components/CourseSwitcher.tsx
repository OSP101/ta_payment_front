...
export default function CourseSwitcher({
  ...
  return (
    ...
    >
      ...
      <Autocomplete.Trigger className="min-w-0 items-center! gap-1! shadow-none! border! border-transparent! bg-transparent! rounded-md px-2! py-1.5! text-foreground hover:border-border! hover:bg-surface-secondary!">
